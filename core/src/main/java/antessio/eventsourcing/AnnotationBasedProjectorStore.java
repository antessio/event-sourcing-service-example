 ...
 *
 */
public class AnnotationBasedProjectorStore implements ProjectorStore {

    private static final Logger LOGGER = Logger.getLogger(AnnotationBasedProjectorStore.class.getCanonicalName());
    private final Map<Class<? extends Event<? extends Aggregate>>, Projector> projectorsMap;
    ...
    private <A extends Aggregate> Optional<Constructor<Projector<A, Event<A>>>> getProjectorConstructor(Class<?> clazz) {
